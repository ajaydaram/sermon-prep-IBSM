      ...
      <div className="bg-white border border-[#141414]/20 p-4 rounded-xl flex flex-col md:flex-row items-center justify-between gap-4 shadow-xs">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs">
          ...
          <button
            ...
            className="px-3 py-1.5 border border-[#141414] text-[#141414] hover:bg-[#141414] hover:text-white rounded font-bold text-xs flex items-center gap-1.5 transition-colors"
          >
            {copied ? <Check className="w-3.5 h-3.5 text-emerald-500" /> : <Copy className="w-3.5 h-3.5" />}
            <span>{copied ? "Copied Matrix" : "Export Data"}</span>
          </button>
        </div>
      </div>
